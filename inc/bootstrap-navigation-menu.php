<?php
/**
 * Bootstrap navigation menu implementation for Wordpress.
 *
 * @package Gutspot
 * @since Gutspot Theme 1.0
 */

class Bootstrap_Navigation_Menu extends Walker_Nav_Menu {
  ...
  function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
    ...
    $classes[] = ($depth == 0 && !$args->has_children && ($item->current || $item->current_item_ancestor)) ? 'active' : '';
